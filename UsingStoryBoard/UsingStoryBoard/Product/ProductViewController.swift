...
class ProductViewController: UIViewController, UIImagePickerControllerDelegate & UINavigationControllerDelegate, UITextFieldDelegate, UIScrollViewDelegate  {
    ...
    override func viewDidLoad() {
        ...
        ProductRatingField.delegate = self
        ProductCompanyIdField.delegate = self
